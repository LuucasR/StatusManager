...
export const en = {
  ...
  "attendance.entriesSaved": "{count} arrival(s) saved",
  "attendance.save": "Save",
  "attendance.saveAll": "Save all ({count})",
  "attendance.refresh": "Refresh",
  "attendance.summaryHelp":
    "Only minutes after the calendar's start time count: arriving on time leaves the allowance untouched.",
  ...
  "patchNotes.eyebrow": "Weekly progress",
  "patchNotes.title": "Patch notes",
  "patchNotes.subtitle": "Write what you moved forward this week. Everyone can read the whole team's notes.",
  "patchNotes.subtitleStaff": "Review the team's sections, close the week, publish a version and download the PDF.",
  "patchNotes.previousWeek": "Previous week",
  "patchNotes.nextWeek": "Next week",
  "patchNotes.thisWeek": "this week",
  "patchNotes.status.DRAFT": "Draft",
  "patchNotes.status.CLOSED": "Closed for review",
  "patchNotes.status.PUBLISHED": "Published",
  "patchNotes.closedNotice": "This week is closed for review. Only supervisors and administrators can still edit it.",
  "patchNotes.publishedNotice": "This week is published and can no longer be edited.",
  "patchNotes.mySection": "My section",
  "patchNotes.addEntry": "Add entry",
  "patchNotes.myEmpty": "You have not written anything for this week yet.",
  "patchNotes.suggestions": "Tasks you worked on this week without a note yet:",
  "patchNotes.teamSection": "Team",
  "patchNotes.teamEmpty": "Nobody else has written for this week yet.",
  "patchNotes.authorEntries": "{name} ({count})",
  "patchNotes.newEntry": "New entry",
  "patchNotes.editEntry": "Edit entry",
  "patchNotes.category": "Category",
  "patchNotes.linkedTask": "Linked task",
  "patchNotes.linkedTaskHelp": "Tasks you booked time on this week. The PDF adds the time spent on it.",
  "patchNotes.noTask": "No task",
  "patchNotes.note": "Note",
  "patchNotes.notePlaceholder": "What changed, as a player or the team would read it",
  "patchNotes.internal": "Internal note (left out of the public PDF)",
  "patchNotes.internalChip": "Internal",
  "patchNotes.saveEntry": "Save entry",
  "patchNotes.confirmDelete": "Delete this entry?",
  "patchNotes.category.FEATURE": "Feature",
  "patchNotes.category.CONTENT": "Content",
  "patchNotes.category.BALANCE": "Balance",
  "patchNotes.category.FIX": "Bug fix",
  "patchNotes.category.ART": "Art",
  "patchNotes.category.AUDIO": "Audio",
  "patchNotes.category.UI": "UI / UX",
  "patchNotes.category.PERFORMANCE": "Performance",
  "patchNotes.category.OTHER": "Other",
  "patchNotes.adminTitle": "Review and publishing",
  "patchNotes.version": "Version",
  "patchNotes.weekTitle": "Title",
  "patchNotes.summary": "Summary",
  "patchNotes.summaryPlaceholder": "Intro printed at the top of the patch notes",
  "patchNotes.saveHeader": "Save",
  "patchNotes.saved": "Patch notes saved.",
  "patchNotes.closeWeek": "Close week",
  "patchNotes.reopenWeek": "Reopen",
  "patchNotes.publish": "Publish",
  "patchNotes.unpublish": "Unpublish",
  "patchNotes.confirmPublish": "Publish this week? Nobody will be able to edit it afterwards.",
  "patchNotes.versionNeeded": "Set and save a version before publishing.",
  "patchNotes.pdfInternal": "Internal PDF",
  "patchNotes.pdfPublic": "Public PDF",
  "patchNotes.missingAuthors": "Booked task time but wrote nothing: {names}",
  "patchNotes.undocumentedTasks": "Tasks with time and no notes: {tasks}",
  "patchNotes.timePerTask": "Time per task",
  "patchNotes.who": "Who",
  "patchNotes.noTime": "No time was booked against tasks this week.",
  "patchNotes.noNotes": "No notes",
  "patchNotes.noTimeBooked": "No time booked",
  "patchNotes.taskTimeHelp": "Time the team booked on this task this week",
  "error.INVALID_WEEK": "The week must be a Monday as YYYY-MM-DD",
  "error.PATCH_WEEK_LOCKED": "This week can no longer be edited",
  "error.INVALID_PATCH_ENTRY": "Invalid patch note entry",
  "error.PATCH_ENTRY_NOT_FOUND": "Patch note entry not found",
  "error.PATCH_ENTRY_FORBIDDEN": "You can only edit your own entries",
  "error.PATCH_VERSION_TAKEN": "Another week already uses that version",
  "error.PATCH_INVALID_TRANSITION": "The week cannot move to that status from its current one",
  "error.PATCH_VERSION_REQUIRED": "Set a version before publishing the week",
} as const;
...
const es: Record<TranslationKey, string> = {
  ...
  "attendance.entriesSaved": "{count} entrada(s) guardada(s)",
  "attendance.save": "Guardar",
  "attendance.saveAll": "Guardar todo ({count})",
  "attendance.refresh": "Actualizar",
  "attendance.summaryHelp":
    "Solo cuentan los minutos después de la hora de inicio del calendario: llegar a horario no descuenta de la tolerancia.",
  ...
  "nav.patchNotes": "Patch notes",
  "patchNotes.eyebrow": "Avance semanal",
  "patchNotes.title": "Patch notes",
  "patchNotes.subtitle": "Escribí lo que avanzaste esta semana. Todos pueden leer las notas del equipo.",
  "patchNotes.subtitleStaff": "Revisá las secciones del equipo, cerrá la semana, publicá una versión y descargá el PDF.",
  "patchNotes.previousWeek": "Semana anterior",
  "patchNotes.nextWeek": "Semana siguiente",
  "patchNotes.thisWeek": "esta semana",
  "patchNotes.status.DRAFT": "Borrador",
  "patchNotes.status.CLOSED": "Cerrada para revisión",
  "patchNotes.status.PUBLISHED": "Publicada",
  "patchNotes.closedNotice": "Esta semana está cerrada para revisión. Solo supervisores y administradores pueden editarla.",
  "patchNotes.publishedNotice": "Esta semana está publicada y ya no se puede editar.",
  "patchNotes.mySection": "Mi sección",
  "patchNotes.addEntry": "Agregar entrada",
  "patchNotes.myEmpty": "Todavía no escribiste nada para esta semana.",
  "patchNotes.suggestions": "Tareas en las que trabajaste esta semana y todavía no tienen nota:",
  "patchNotes.teamSection": "Equipo",
  "patchNotes.teamEmpty": "Nadie más escribió todavía para esta semana.",
  "patchNotes.authorEntries": "{name} ({count})",
  "patchNotes.newEntry": "Nueva entrada",
  "patchNotes.editEntry": "Editar entrada",
  "patchNotes.category": "Categoría",
  "patchNotes.linkedTask": "Tarea vinculada",
  "patchNotes.linkedTaskHelp": "Tareas en las que registraste tiempo esta semana. El PDF suma el tiempo dedicado.",
  "patchNotes.noTask": "Sin tarea",
  "patchNotes.note": "Nota",
  "patchNotes.notePlaceholder": "Qué cambió, como lo leería un jugador o el equipo",
  "patchNotes.internal": "Nota interna (no sale en el PDF público)",
  "patchNotes.internalChip": "Interna",
  "patchNotes.saveEntry": "Guardar entrada",
  "patchNotes.confirmDelete": "¿Eliminar esta entrada?",
  "patchNotes.category.FEATURE": "Funcionalidad",
  "patchNotes.category.CONTENT": "Contenido",
  "patchNotes.category.BALANCE": "Balance",
  "patchNotes.category.FIX": "Corrección",
  "patchNotes.category.ART": "Arte",
  "patchNotes.category.AUDIO": "Audio",
  "patchNotes.category.UI": "UI / UX",
  "patchNotes.category.PERFORMANCE": "Rendimiento",
  "patchNotes.category.OTHER": "Otro",
  "patchNotes.adminTitle": "Revisión y publicación",
  "patchNotes.version": "Versión",
  "patchNotes.weekTitle": "Título",
  "patchNotes.summary": "Resumen",
  "patchNotes.summaryPlaceholder": "Introducción que se imprime al principio de las patch notes",
  "patchNotes.saveHeader": "Guardar",
  "patchNotes.saved": "Patch notes guardadas.",
  "patchNotes.closeWeek": "Cerrar semana",
  "patchNotes.reopenWeek": "Reabrir",
  "patchNotes.publish": "Publicar",
  "patchNotes.unpublish": "Despublicar",
  "patchNotes.confirmPublish": "¿Publicar esta semana? Después nadie podrá editarla.",
  "patchNotes.versionNeeded": "Cargá y guardá una versión antes de publicar.",
  "patchNotes.pdfInternal": "PDF interno",
  "patchNotes.pdfPublic": "PDF público",
  "patchNotes.missingAuthors": "Registraron tiempo en tareas pero no escribieron nada: {names}",
  "patchNotes.undocumentedTasks": "Tareas con tiempo y sin notas: {tasks}",
  "patchNotes.timePerTask": "Tiempo por tarea",
  "patchNotes.who": "Quién",
  "patchNotes.noTime": "Esta semana no se registró tiempo en tareas.",
  "patchNotes.noNotes": "Sin notas",
  "patchNotes.noTimeBooked": "Sin tiempo registrado",
  "patchNotes.taskTimeHelp": "Tiempo que el equipo dedicó a esta tarea esta semana",
  "error.INVALID_WEEK": "La semana tiene que ser un lunes con formato AAAA-MM-DD",
  "error.PATCH_WEEK_LOCKED": "Esta semana ya no se puede editar",
  "error.INVALID_PATCH_ENTRY": "Entrada de patch notes inválida",
  "error.PATCH_ENTRY_NOT_FOUND": "No se encontró la entrada",
  "error.PATCH_ENTRY_FORBIDDEN": "Solo podés editar tus propias entradas",
  "error.PATCH_VERSION_TAKEN": "Otra semana ya usa esa versión",
  "error.PATCH_INVALID_TRANSITION": "La semana no puede pasar a ese estado desde el actual",
  "error.PATCH_VERSION_REQUIRED": "Cargá una versión antes de publicar la semana",
};
