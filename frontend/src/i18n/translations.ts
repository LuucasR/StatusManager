...
export const en = {
  ...
  "downloads.eyebrow": "Company tools",
  "downloads.title": "Downloads",
  "downloads.subtitle": "Software and tools the team uses. Download them from here.",
  "downloads.subtitleAdmin": "Add links to the tools the team uses. The files stay hosted where they are.",
  "downloads.add": "Add tool",
  "downloads.new": "New tool",
  "downloads.edit": "Edit tool",
  "downloads.empty": "There are no tools to download yet.",
  "downloads.download": "Download",
  "downloads.name": "Name",
  "downloads.url": "Download link",
  "downloads.urlHelp": "An https link to the file on Google Drive, OneDrive, GitHub Releases or similar",
  "downloads.version": "Version",
  "downloads.platform": "Platform",
  "downloads.size": "Size",
  "downloads.description": "Description",
  "downloads.position": "Order",
  "downloads.positionHelp": "Lower numbers show first",
  "downloads.save": "Save",
  "downloads.confirmDelete": "Remove this tool from the list?",
  "error.UTILITY_NOT_FOUND": "Download not found",
  "nav.warnings": "Warnings",
  "warnings.eyebrow": "Discipline",
  "warnings.title": "Warnings",
  "warnings.subtitle": "Warnings you have received. Going over the late-arrival allowance of a half-month adds one automatically.",
  "warnings.subtitleAdmin": "Every warning on the team. Automatic ones come from going over the late-arrival allowance; you can also grant and revoke them here.",
  "warnings.grant": "Grant warning",
  "warnings.grantTitle": "Grant a warning",
  "warnings.reason": "Reason",
  "warnings.revoke": "Revoke",
  "warnings.revokeTitle": "Revoke warning",
  "warnings.revokeReason": "Why is it being revoked?",
  "warnings.cancel": "Cancel",
  "warnings.confirm": "Confirm",
  "warnings.granted": "Warning granted",
  "warnings.revokedNotice": "Warning revoked",
  "warnings.employee": "Employee",
  "warnings.allEmployees": "Everyone",
  "warnings.showRevoked": "Show revoked",
  "warnings.date": "Date",
  "warnings.type": "Type",
  "warnings.status": "Status",
  "warnings.source.AUTO_LATE": "Late arrivals",
  "warnings.source.MANUAL": "Manual",
  "warnings.active": "Active",
  "warnings.revoked": "Revoked",
  "warnings.revokedBy": "Revoked by {name}: {reason}",
  "warnings.revokedAuto": "Revoked automatically: {reason}",
  "warnings.grantedBy": "Granted by {name}",
  "warnings.system": "Automatic",
  "warnings.half": "{month}, {range}",
  "warnings.lateUsed": "{used} / {tolerance} min",
  "warnings.empty": "No warnings.",
  "warnings.myEmpty": "You have no warnings. Keep it up!",
  "warnings.activeCount": "{count} active",
  "warnings.perEmployee": "Active warnings per person",
  "warnings.truncated": "Showing the latest 1000 warnings. Filter by employee to see older ones.",
  "error.WARNING_NOT_FOUND": "Warning not found",
  "error.WARNING_ALREADY_REVOKED": "The warning is already revoked",
} as const;
...
const es: Record<TranslationKey, string> = {
  ...
  "downloads.eyebrow": "Herramientas de la empresa",
  "downloads.title": "Descargas",
  "downloads.subtitle": "Software y herramientas que usa el equipo. Descargalas desde acá.",
  "downloads.subtitleAdmin": "Agregá links a las herramientas que usa el equipo. Los archivos siguen alojados donde están.",
  "downloads.add": "Agregar herramienta",
  "downloads.new": "Nueva herramienta",
  "downloads.edit": "Editar herramienta",
  "downloads.empty": "Todavía no hay herramientas para descargar.",
  "downloads.download": "Descargar",
  "downloads.name": "Nombre",
  "downloads.url": "Link de descarga",
  "downloads.urlHelp": "Un link https al archivo en Google Drive, OneDrive, GitHub Releases o similar",
  "downloads.version": "Versión",
  "downloads.platform": "Plataforma",
  "downloads.size": "Tamaño",
  "downloads.description": "Descripción",
  "downloads.position": "Orden",
  "downloads.positionHelp": "Los números más bajos aparecen primero",
  "downloads.save": "Guardar",
  "downloads.confirmDelete": "¿Quitar esta herramienta de la lista?",
  "error.UTILITY_NOT_FOUND": "No se encontró la descarga",
  "nav.warnings": "Warnings",
  "warnings.eyebrow": "Disciplina",
  "warnings.title": "Warnings",
  "warnings.subtitle": "Los warnings que recibiste. Superar la tolerancia de llegadas tarde de una quincena suma uno automáticamente.",
  "warnings.subtitleAdmin": "Todos los warnings del equipo. Los automáticos salen de superar la tolerancia de llegadas tarde; también podés otorgarlos y anularlos acá.",
  "warnings.grant": "Otorgar warning",
  "warnings.grantTitle": "Otorgar un warning",
  "warnings.reason": "Motivo",
  "warnings.revoke": "Anular",
  "warnings.revokeTitle": "Anular warning",
  "warnings.revokeReason": "¿Por qué se anula?",
  "warnings.cancel": "Cancelar",
  "warnings.confirm": "Confirmar",
  "warnings.granted": "Warning otorgado",
  "warnings.revokedNotice": "Warning anulado",
  "warnings.employee": "Empleado",
  "warnings.allEmployees": "Todos",
  "warnings.showRevoked": "Mostrar anulados",
  "warnings.date": "Fecha",
  "warnings.type": "Tipo",
  "warnings.status": "Estado",
  "warnings.source.AUTO_LATE": "Llegadas tarde",
  "warnings.source.MANUAL": "Manual",
  "warnings.active": "Vigente",
  "warnings.revoked": "Anulado",
  "warnings.revokedBy": "Anulado por {name}: {reason}",
  "warnings.revokedAuto": "Anulado automáticamente: {reason}",
  "warnings.grantedBy": "Otorgado por {name}",
  "warnings.system": "Automático",
  "warnings.half": "{month}, {range}",
  "warnings.lateUsed": "{used} / {tolerance} min",
  "warnings.empty": "No hay warnings.",
  "warnings.myEmpty": "No tenés warnings. ¡Seguí así!",
  "warnings.activeCount": "{count} vigente(s)",
  "warnings.perEmployee": "Warnings vigentes por persona",
  "warnings.truncated": "Se muestran los últimos 1000 warnings. Filtrá por empleado para ver los anteriores.",
  "error.WARNING_NOT_FOUND": "No se encontró el warning",
  "error.WARNING_ALREADY_REVOKED": "El warning ya está anulado",
};
